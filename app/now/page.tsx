      ...
      <section className="container mx-auto px-8 py-32 lg:py-48 min-h-screen">
        ...
        >
            <div className="flex items-center gap-4 mb-12">
                ...
                <Badge variant="outline" className="h-8 px-4 border-cyan/20 text-cyan">Active Protocol</Badge>
            </div>
            ...
            <div className="space-y-12">
                <Card variant="glass" className="p-8">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h2 className="font-display text-2xl font-bold text-text-1 uppercase tracking-tight">Focusing On</h2>
                    </div>
                    <ul className="space-y-4 font-body text-lg text-text-2">
                        {nowData.focusingOn.map(item => (
                ...
                <Card variant="glass" className="p-8">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h2 className="font-display text-2xl font-bold text-text-1 uppercase tracking-tight">Learning</h2>
                    </div>
                    <ul className="space-y-4 font-body text-lg text-text-2">
