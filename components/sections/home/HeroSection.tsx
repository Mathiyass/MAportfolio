  ...
  return (
    <section className="relative flex min-h-[90vh] items-center justify-center px-4 pt-20 overflow-hidden">
      ...
      <div className="container mx-auto grid lg:grid-cols-12 gap-16 items-center relative z-10">
        ...
        {/* Left Column: Intelligence Protocol */}
        <div className="lg:col-span-7 flex flex-col items-start gap-10">
          ...
          >
            <span className="font-mono text-[10px] tracking-[0.4em] text-cyan uppercase opacity-70">System Initialized</span>
          ...
          <div className="space-y-6">
            ...
            >
              NEXUS <br/>
              <span className="text-cyan">PRIME.</span>
            </motion.h1>
          ...
          >
            <Link href="/projects" passHref>
              <Button variant="primary" size="lg" className="h-16 px-10 gap-3 text-xs tracking-[0.2em] shadow-[0_0_40px_-10px_rgba(0,240,255,0.4)] hover:scale-105 transition-all">
                INITIALIZE CORE <ArrowRight size={16} />
              </Button>
            </Link>
          ...
          >
            <div className="flex flex-col gap-1">
              <span className="font-mono text-[9px] uppercase tracking-widest text-text-4">Kernel Status</span>
            ...
            <div className="flex flex-col gap-1">
              <span className="font-mono text-[9px] uppercase tracking-widest text-text-4">System Link</span>
              <div className="text-text-1 font-head font-bold text-sm">ENCRYPTED</div>
            </div>
            <div className="flex flex-col gap-1">
              <span className="font-mono text-[9px] uppercase tracking-widest text-text-4">Uptime</span>
              <div className="text-text-1 font-head font-bold text-sm">99.98%</div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="lg:col-span-5 relative flex items-center justify-center">
           ...
           >
             ...
             <div className="absolute top-6 right-6 flex flex-col items-end gap-1 text-right z-30 mix-blend-difference">
               <span className="font-mono text-[9px] tracking-[0.3em] text-red uppercase">Protocol</span>
               <span className="font-mono text-[10px] tracking-widest text-text-1 uppercase">QUANTUM_SEC_V4</span>
             </div>
             ...
             <div className="w-full h-full rounded-[var(--radius-2xl)] glass-refraction border-white/5 relative overflow-hidden group z-10">
               ...
               <div className="absolute bottom-10 left-10 right-10 z-20 pointer-events-none">
                 <div className="flex items-center gap-3 mb-3">
                   ...
                   <span className="font-mono text-[10px] text-cyan tracking-widest uppercase">MASCOT_UNIT_BYTE</span>
                 </div>
                 <div className="font-display text-3xl font-black text-text-0 uppercase leading-none">Interactive Core.</div>
               </div>
